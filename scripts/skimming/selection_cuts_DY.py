...
second_skim_dir = 'TT_CR_MET_trig_JetLooseId'
...
#             'weight_muon_trigger_down': weights * pileup_weights['nominal'] * (muon_weights['muon_trigger_SF'] - muon_weights['muon_trigger_SF_syst']),
    ...
    def process(self, events):
        ...
        good_jet_mask = (events.Jet.isLoose)
...
if __name__ == "__main__":
    ...
    for samp in dataset_runnable.keys():
        print(samp)
        if "QCD" in samp or "MET" in samp or "TT" in samp or "Stau" in samp or "W" in samp: continue
        samp_runnable = {}
