...
if "Stau" in file:
  ak.to_parquet(genDisMuon, "genDisMuon.parquet")
  ak.to_parquet(allGenDisMuon, "allGenDisMuon.parquet")
  ak.to_parquet(genDisElectron, "genDisElectron.parquet")
  ak.to_parquet(allGenDisElectron, "allGenDisElectron.parquet")

  ak.to_parquet(GenMuon_dxy, "Stau_GenMuon_dxy.parquet")
  ak.to_parquet(GenMuon_lxy, "Stau_GenMuon_lxy.parquet")
  ak.to_parquet(GenElectron_dxy, "Stau_GenElectron_dxy.parquet")
  ak.to_parquet(GenElectron_lxy, "Stau_GenElectron_lxy.parquet")
